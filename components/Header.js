...
function Header() {
  return (
    <div className="flex top-0 flex-row md:ml-20 justify-between md:items-center md:mr-2 h-auto px-4 py-2 rounded-md">
        <Image 
        ...
        <div className="inline-flex ">
            ...
            <a className="p-2 sm:hover:scale-110 hover:z-50" href="https://discord.com/invite/CjCS2vseUD">
                <Image 
            ...
            <a className="p-2 sm:hover:scale-105 hover:z-50" href="https://chat.whatsapp.com/C2UEC7NfSQt6SxBpJxt3XA">
                <WhatsappIcon className="WhatsApp" size={60} borderRadius={20} round={false}/>
            </a>
